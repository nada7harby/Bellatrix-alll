  ...
  const cleanComponents = `
      ...
      HRModulesSection: {
        ...
        modules: [
          ...
          { name: "Compliance Management", description: "Stay compliant with regulations", icon: "" },
      ...
      PayrollPainPointsSection: {
        ...
        items: [
          { title: "Manual Processing", description: "Automate calculations and reduce errors", icon: "" },
          { title: "Compliance Issues", description: "Stay current with tax laws and regulations", icon: "" },
      ...
      ImplementationWhyChooseSection: {
        ...
        features: [
          ...
          { number: "03", title: "24/7 Support", description: "Round-the-clock technical support & monitoring", icon: "" },
        ],
      },
      ...
      IntegrationBenefitsSection: {
        ...
        benefits: [
          ...
          { title: "Real-Time Visibility", description: "Get real-time insights across all systems", icon: "" },
      ...
      CustomizationCTASection: {
        ...
        features: [
          ...
          { title: "Ongoing Support", description: "Continuous support and maintenance", icon: "" },
      ...
      HomeServicesSection: {
        ...
        services: [
          { title: "Implementation", description: "Complete NetSuite setup and configuration", icon: "", link: "/services/implementation" },
      ...
      ServiceGrid: {
        ...
        services: [
          { name: "NetSuite Implementation", description: "Complete NetSuite setup and configuration", icon: "", link: "/services/implementation", features: ["System setup", "Data migration", "User training"], price: "Starting at $4,900" },
          ...
          { name: "NetSuite Support", description: "Ongoing support and maintenance", icon: "", link: "/services/support", features: ["24/7 support", "System maintenance", "Performance optimization"], price: "Monthly plans" },
        ],
      },
      ...
      ProcessSection: {
        ...
        process: [
          ...
          { step: 3, title: "Execution", description: "Implement with precision and care", icon: "" },
